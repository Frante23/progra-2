...
class Animal(Organismo):
    ...
    def _init_(self, posicion, vida, energia, velocidad, dieta, id_animal, imagen_path=None, filas=None, columnas=None):
...
class Leon(Animal):
    ...
    def _init_(self, posicion, vida, energia, velocidad, dieta, id_leon, imagen_path=None, filas=None, columnas=None):
